...
def store_bridge_snapshot(snapshot: dict[str, Any]) -> dict[str, Any]:
    ...
    _memory_bridge[key] = {"payload": snapshot, "ts": time.time()}
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute(
                    ...
                    INSERT INTO fantasyiq_draft_bridge_snapshots
                        (league_id, season, payload, bridge_source, updated_at)
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        try:
            ...
            snapshot = store_bridge_snapshot(clean_snapshot(payload))
            json_response(
                self,
                HTTPStatus.OK,
                {
