...
- One year of access to the configured dashboard.
...
- Custom feature development for one customer.
- League management inside ESPN.
- Advice guaranteeing fantasy football outcomes.

## Requirements

- The customer must provide the correct ESPN league ID and season.
- The ESPN league must be public for live sync.
